export class Generator {
    ...
    transpileAckermann() {
        ...
        return "Math.atan(wheelBase / (turnRadius + rearTrack / 2))"
    }



    transpileCar() {
        const snippet = `class Car {
    ...
    transpileSuspension() {
        const snippet = `class Suspension {
           distance = 0.0;
           spring = new Spring();
    ...
    transpileDifferential() {
        const snippet = `class Differential {
           type = {
               ClutchPack: 1,
               Locked: 2, // drift
               Open: 3,
